...
export default async function AdminOverviewPage() {
  ...
  const kpis = [
    ...
    },
    {
      ...
      value: snapshot.approvedTechs.toString(),
      icon: Wrench,
      color: "text-[#059669]",
      bg: "bg-[#d1fae5]",
    },
    {
      ...
      value: snapshot.pendingTechs.toString(),
      icon: Clock,
      color: "text-amber-700",
      bg: "bg-amber-50",
      alert: snapshot.pendingTechs > 0,
    },
    {
      label: "Reservas completadas",
      value: snapshot.bookingStatusCounts.completed.toString(),
      icon: CalendarDays,
      color: "text-[#1d4ed8]",
      bg: "bg-blue-50",
    },
    {
      label: "GMV total",
      value: formatPrice(snapshot.totalGMV),
      icon: DollarSign,
      color: "text-[#059669]",
      bg: "bg-[#d1fae5]",
    },
    {
      ...
      value: formatPrice(snapshot.totalPlatformRevenue),
      icon: DollarSign,
      color: "text-[#d97706]",
      bg: "bg-amber-50",
    },
    {
      ...
      value: snapshot.activeBookings.toString(),
      icon: CalendarDays,
      color: "text-[#1d4ed8]",
      bg: "bg-blue-50",
    },
    {
      ...
      value: snapshot.totalReviews.toString(),
      icon: Star,
      color: "text-[#d97706]",
      bg: "bg-amber-50",
    },
  ...
  return (
    <section>
        ...
        <div className="mb-6 flex items-center justify-between rounded-xl border border-amber-200 bg-amber-50 px-4 py-3">
          <div className="flex items-center gap-2">
            ...
            <span className="text-sm font-medium text-amber-800">
              {snapshot.pendingTechs} técnico{snapshot.pendingTechs !== 1 ? "s" : ""} esperando aprobación
            </span>
          </div>
          <Link
      ...
      <div className="mt-8">
        <AdminOverviewLive initialData={snapshot} />
      </div>
