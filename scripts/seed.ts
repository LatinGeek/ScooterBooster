  ...
  const technicians = [
    {
      ...
      bio: "Técnico especializado en scooters Xiaomi y Segway con 4 años de experiencia. Certificado en modificaciones de firmware y mantenimiento avanzado.",
      photoURL: "",
      phone: "+59899111001",
      whatsappNumber: "+59899111001",
      location: "Montevideo Centro",
      services: ALL_SERVICES,
      supportedBrands: [BRAND_IDS.xiaomi, BRAND_IDS.segway, BRAND_IDS.inokim],
      availability: {
    ...
    },
    {
      ...
      bio: "Especialista en scooters de alto rendimiento. Dualtron, Kaabo y VSETT son mi especialidad. Trabajo a domicilio en todo Montevideo.",
      photoURL: "",
      phone: "+59899111002",
      whatsappNumber: "+59899111002",
      location: "Pocitos, Montevideo",
      services: ALL_SERVICES,
      supportedBrands: [BRAND_IDS.dualtron, BRAND_IDS.kaabo, BRAND_IDS.vsett, BRAND_IDS.zero],
      availability: {
